                    ...
                    <div className="row g-4">
                        <div className="col-lg-6 wow slideUp" data-delay=".4">
                            <div className="faq-image">
                                <img src="/img/faq/faq-image.jpeg" alt="faq-img" />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="faq-content style-2">
                                <SectionTitle>
                                    <SectionTitle.SubTitle>Frequently Asked Questions</SectionTitle.SubTitle>
                                    <SectionTitle.Title>Common Questions About Our Glass & Mirror Services</SectionTitle.Title>
                                </SectionTitle>
